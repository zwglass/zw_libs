...
class TestDbInsert(object):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.db_insert_class = DbInsert('sqlite3', **{'sqlite3_file_path': '/Users/zhaoshenghua/development/shell_text/db/zw_db_lib/test_project/test_db.sqlite3'})
    ...
    def insert_data(self):
        ...
        insert_kwargs = {'platform_code': 1, 'goods_title': 'test goods003', 'goods_code': 'ABC_test_goods_003'}
