...
class TestQueryDb(object):
    ...
    def __init__(self) -> None:
        ...
        self.db_get_class = DbGet('sqlite3', **{'sqlite3_file_path': '/Users/zhaoshenghua/development/shell_text/db/zw_db_lib/test_project/test_db.sqlite3'})
